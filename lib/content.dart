...
class Content {
  static const Map<String, String> _bundled = {
    ...
    // ── التواصل — تُحرَّر من لوحة التحكم ──
    'contact.email': 'almubarky05588@gmail.com',
    'contact.whatsapp': '966559796917',
    'contact.body':
        'يسعدنا سماع ملاحظاتك واقتراحاتك، أو الإبلاغ عن معلومة غير دقيقة '
        'عن أي مكان.',
    // رقم التطبيق في آبل — يبقى فارغاً حتى يُنشر، وعندها يظهر زر التقييم
    'app.ios_id': '',
  };
