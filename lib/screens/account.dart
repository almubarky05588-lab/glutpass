...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget build(BuildContext ctx) {
    return _me == null ? _form() : _profile();
  }
  ...
  Widget _profile() => ListView(
        ...
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(color: cGreen, shape: BoxShape.circle),
          ...
          Row(children: [
            ...
            _stat(_me!['city'] as String, 'المدينة'),
          ]),
          const SizedBox(height: 14),
          if (_me!['celiac'] == true)
            Container(
              ...
              child: const Row(
                  ...
                  children: [
                    Text('مصاب بحساسية القمح — أصواتك بوزن مضاعف',
          ...
          if (_signup) ...[
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  Icon(_celiac ? Icons.check_box : Icons.check_box_outline_blank,
                      color: _celiac ? cGreen : cGrey, size: 20),
                  const Spacer(),
                  const Column(
