...
class _VoteScreenState extends State<VoteScreen> {
  ...
  static const opts = [
    ['SAFE_NO_SYMPTOMS', 'آمن تماماً، لا أعراض', 'sentiment_satisfied_alt'],
    ['MILD_SYMPTOMS', 'أعراض خفيفة', 'sentiment_neutral'],
    ['NOT_SAFE', 'غير آمن', 'sentiment_dissatisfied'],
  ];
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      }, onConflict: widget.dish == null ? 'user_id,place_id' : 'user_id,dish_id');
      setState(() => _done = true);
    } catch (e) {
      setState(() => _msg = '$e');
    } finally {
  ...
  Widget build(BuildContext ctx) {
    return Scaffold(
      backgroundColor: cBg,
      body: SafeArea(
        child: _done ? _thanks(ctx) : _form(ctx),
      ),
    );
  }
            ...
            child: Row(children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                Text(
                    widget.dish == null
                        ? (widget.place.branch ?? '')
                        : '${widget.place.nameAr} — ${widget.place.branch ?? ''}',
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: on ? c : cBorder, width: on ? 1.6 : 1)),
                  child: Row(children: [
                    Icon(on ? Icons.radio_button_checked : Icons.circle_outlined,
                        color: on ? c : cGrey, size: 20),
                    const Spacer(),
                    Text(o[1],
                        style: TextStyle(
                            fontSize: 14,
          ...
          Row(
              ...
              children: List.generate(5, (i) {
                ...
                return IconButton(
                  ...
                  icon: Icon(
                      _stars >= n ? Icons.star : Icons.star_border,
